...
Expanding on some XUL/XAML/XOML concepts, envisioning a related knowledge-representation technology which binds to JavaScript while interoperable with the [Shadow DOM](https://en.wikipedia.org/wiki/Shadow_DOM) and [WebAssembly](https://en.wikipedia.org/wiki/WebAssembly), the following example showcases a number of markup-related techniques.
